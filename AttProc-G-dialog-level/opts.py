...
parser.add_argument('--attImgFeatureSize', type=int,  default=512, help='Size of the attention image feature');
parser.add_argument('--attImgFeatureHeight', type=int,  default=7, help='Height of the attention image feature');
parser.add_argument('--attImgFeatureWidth', type=int,  default=7, help='Width of the attention image feature');
parser.add_argument('--attVectSize', type=int,  default=128, help='Attention vector size');
parser.add_argument('--attTimes', type=int,  default=4, help='Number of attention time steps');
...
parser.add_argument('--LRateDecay', type=int,  default=10, help='After lr_decay epochs lr reduces to lrDecayRate*lr')
parser.add_argument('--lrDecayRate', type=float,  default=0.9997592083, help='Decay for learning rate')
parser.add_argument('--minLRate', type=float,  default=5e-5, help='Minimum learning rate')
