...
parser.add_argument('--numEpochs', type=int,  default=80, help='Epochs')
parser.add_argument('--LRateDecay', type=int,  default=1, help='After lr_decay epochs lr reduces to lrDecayRate*lr')
parser.add_argument('--lrDecayRate', type=float,  default=0.99, help='Decay for learning rate')
parser.add_argument('--minLRate', type=float,  default=1e-4, help='Minimum learning rate')
parser.add_argument('--clipNorm', type=float,  default=5.0, help='Clip gradients to this norm')
parser.add_argument('--ckptInterval', type=int,  default=10000, help='Store checkpoint for every ckptInterval batchs')
